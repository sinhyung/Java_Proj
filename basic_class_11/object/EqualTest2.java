...
public class EqualTest2 {
	public static void main(String[] args) {
		...
		Student2 Lee2 = new Student2 ( 1000, "이순");
		System.out.println(Lee);
		System.out.println(Lee == Lee2);      // false (주소)
		System.out.println(Lee.equals(Lee2)); // false (주소)  ===> True (equals()메소드를 재정의)
			// Object Class의 equals ()메서드는 주소를 비교합니다.
			// 객체의 studentID가 같은 경우 같다라고 재정의 equals() 메소드를 오버라이딩 합니다. 

		System.out.println("Lee 의 hashcode : " + Lee.hashCode());
