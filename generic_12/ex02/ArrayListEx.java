...
public class ArrayListEx {		//이름을 4개 입력 받아 ArrayList에 저장 하고 제일 긴이름을 출력 
	...
	public static void main(String[] args) {
		...
		System.out.println( a.get(0) + " : 0 번방의 글자 길이는 " + a.get(0).length());
		System.out.println( a.get(1) + " : 1 번방의 글자 길이는 " + a.get(1).length());
		System.out.println( a.get(2) + " : 2 번방의 글자 길이는 " + a.get(2).length());
		System.out.println( a.get(3) + " : 3 번방의 글자 길이는 " + a.get(3).length());
	}
