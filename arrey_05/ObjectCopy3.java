...
public class ObjectCopy3 {
	...
	public static void main(String[] args) {  // 배열의 깊은 복사 
		...
		for (int i=0 ; i < bookArray2.length; i++) { // bookArray2 출력 
...
// P 152. ArrayCreateByValueListExample.java
// P 154. ArrayCreateByValueListExample2.java
// P 157. ArrayCreateNewExample.java
