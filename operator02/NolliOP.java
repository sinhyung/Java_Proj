...
public class NolliOP {
	public static void main(String[] args) {
		 ...
		 * 2] b1 || b2 : b1과 b2가 모두가 false일때 false 이고 나머지는 true리턴 
		 *    단 b1이 true이면 b2는 무시하고(계산안하고) true를 리턴한다
		 * 3] b1 & b2 : b1과 b2가 모두가 true일때만 true 이고 나머지는 false리턴
		 *    무조건 b1, b2를 수행한다.
		 * 4] b1 | b2 : b1과 b2가 모두가 false일때 false 이고 나머지는 true리턴
		 *    무조건 b1, b2를 수행한다.
		 *    
		 * 5] ^,| 연산자가 &&,||연산자보다 우선 순위가 높다.
		 */
		/*
		 * 논리합
		 * false && false : false
