...
public class MemberHashSetTest {
	...
	public static void main(String[] args) {
		...
		Member memberKim = new Member(1003, "김길동");		// 중복된 값을 저장 할 수 없다. 
		...
		memberHashSet.addMember(new Member (1010, "홍길순"));
		memberHashSet.showAllMember();   // 저장된 객체를 출력
		
		/*
		 * Set에서 객체를 저장 할때 중복된 값을 저장 하지 않도록 하기 위해서는 ?
		 * 객체의 특정 변수에 대해서 equals() 메소드를 재정의 해줘야 합니다. 
		 */
		
		System.out.println("=======HashSet에 중복된 값을 저장 ======");
		Member memberKim2 = new Member(1003, "김길동");		// equals() 메소드가 재정의 되어있다. 
